# =============================================================================
# Note from Zihao (03/22/2023):
# I don't want to leave useless/outdated/backup code in the main program.
# So here are them. If you really gonna use it later, write more comment.
# =============================================================================


#%% Old RFS where we haven't build the ReadoutTemplateScan.


class ReadoutFrequencyScan2(Scan2D, LevelScan):
